...
from parakeet_mlx.models import tokenizer
from parakeet_mlx.models.cache import ConformerCache, RotatingConformerCache
from parakeet_mlx.models.conformer import Conformer, ConformerArgs
...
class StreamingParakeet:
    ...
    def reset_buffers(self):
        ...
        This method should be called after transcription output to ensure
        subsequent audio chunks start from a clean state without reprocessing
        previously transcribed audio segments.
        """
        # Clear audio and mel buffers
        self.audio_buffer = mx.array([])
        self.mel_buffer = None

        # Reset decoder state for RNN-T models
